...
public class bookingdetails extends JFrame {
	...
	public bookingdetails() {
		...
		lblNewLabel_1.setBounds(52, 84, 46, 14);
		...
		lblNewLabel_4.setBounds(52, 183, 46, 14);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//int noofseat=Integer.parseInt(textField_3.getText());
				//int cost=Integer.parseInt(textField_4.getText());
				//int noofseat=Integer.parseInt(textField_3.getText());
				//int cost=Integer.parseInt(textField.getText());
